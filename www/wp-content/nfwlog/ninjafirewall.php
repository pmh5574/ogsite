...
// WordPress dashboard.                                           //
// ===============================================================//
if ( file_exists('/pmh5547/www/wp-content/plugins/ninjafirewall/lib/firewall.php') ) {
	@include_once '/pmh5547/www/wp-content/plugins/ninjafirewall/lib/firewall.php';
}
// EOF
